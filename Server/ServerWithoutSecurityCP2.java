...
public class ServerWithoutSecurityCP2 {
	...
	public static void main(String[] args) {
		...
		try {
			...
			while (!connectionSocket.isClosed()) {
				...
				//0 for sending nonce
				//1 receiving the content of the file.
				//2 sending cert/file to client
				//3 receiving filename from client
...
//			        System.out.println("Cipher Text : "+ base64format);
				...
				// If the packet is for transferring a chunk of the file
					...
					Cipher dcipher = Cipher.getInstance("AES/ECB/PKCS1Padding");
...
//						toClient.writeInt(1);
			 ...
			 else if (packetType == 4) { //For sending session key
